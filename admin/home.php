...
function home() {
    ...
    if(file_exists(BASE_DIR."docu/docu.php")) {
        $error[$titel][] = false;
        $template[$titel][] = getLanguageValue("home_help_text1").' <a href="'.URL_BASE.'docu/docu.php" target="_blank"><b>'.getLanguageValue("home_help_link_text").'</b></a> '.getLanguageValue("home_help_text2").' <a href="'.URL_BASE.'docu/docu.php?menu=false&amp;artikel=start" target="_blank" class="js-docu-link mo-butten-a-img"><img src="'.ADMIN_ICONS.'/help.png" alt="help" hspace="0" vspace="0" border="0" /></a>';
    } else {
        $error[$titel][] = true;
