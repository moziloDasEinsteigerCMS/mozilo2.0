...
//var FoldMode = exports.FoldMode = function() {
//var regex = "(\\[{1})("+moziloSyntax+"|"+moziloUserSyntax+moziloPluginsActiv+"|"+moziloPluginsDeactiv+")(\\||\\=)*$";
//    this.foldingStartMarker = new RegExp(regex);
//};
...
//regex : "(\\{{1})("+moziloPluginsActiv+"|"+moziloPluginsDeactiv+")(\\|{0,1})"
...
//    this.tagRe = /^(\s*)(<?(\/?)([-_a-zA-Z0-9:!]*)\s*(\/?)>?)/;
 ...
 //   this.foldingStartMarker = /(\{|\[{1})[a-zA-Z0-9_\-]*(\\||\\={1})*$/;

//    this.foldingStartMarker = /(([\{|\[])([-_a-zA-Z0-9]*)([\\||\\=])).*/;
    this.foldingStartMarker = /([\{]([-_a-zA-Z0-9]*)[\\|])[^\}].*/;
   this.foldingStopMarker = /[^\{]*([\}])/;
...
//$("#out").html($("#out").html()+"<br />line="+match.join("<br>"));
...
*/
        if (match) {
            ...
            if (match[1]) {
//$("#out").html($("#out").html()+"<br />open="+match[1]);
...
//$("#out").html($("#out").html()+"<br />stopmark="+match.join(" # "));
        if (match) {
...
(function() {
    ...
    this.getFoldWidget = function(session, foldStyle, row) {
        var line = session.getLine(row);
// $("#out").html($("#out").html()+"<br />foldStyle="+foldStyle);
var match = line.match(this.foldingStartMarker);
if (match)
$("#out").html($("#out").html()+"<br />line start="+match.join(" # "));
var match1 = line.match(this.foldingStopMarker);
if (match1)
$("#out").html($("#out").html()+"<br />line stop="+match1.join(" # "));
// $("#out").html($("#out").html()+"<br />line1="+line);
       if (this.foldingStartMarker.test(line)) {
$("#out").html($("#out").html()+"<br />start="+match.join(" # "));
            return "start";
        }
        if (foldStyle == "markbeginend"
                && this.foldingStopMarker
                && this.foldingStopMarker.test(line)) {
$("#out").html($("#out").html()+"<br />end"+match.join(" # "));
            return "end";
        }
        return "";
    };
